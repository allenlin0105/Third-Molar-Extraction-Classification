...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='../../data/odontoai-v2/train/train.json',
        img_prefix='../../data/odontoai-v2/train/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        type='CocoDataset',
        ann_file='../../data/odontoai-v2/val/val.json',
        img_prefix='../../data/odontoai-v2/val/images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
log_level = 'INFO'
load_from = 'path_to_exp/checkpoints/pretrained_co_deformable_detr_r50_1x_coco.pth'
resume_from = None
workflow = [('train', 1)]
...
auto_resume = False
work_dir = 'path_to_exp/checkpoints/'
gpu_ids = [0]
